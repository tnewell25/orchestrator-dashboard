    ...
    <div className="min-h-screen bg-zinc-50">
      <div className="max-w-3xl mx-auto px-4 py-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-sm font-semibold text-zinc-800">Plants</h1>
            <p className="text-[11px] text-zinc-500 mt-0.5">
              Sites belonging to your accounts. A deal at Bosch Stuttgart is not the same as Bosch Mexico.
            </p>
          </div>
        ...
        <div className="bg-white rounded-lg border border-zinc-200 shadow-sm overflow-hidden">
          {isLoading ? (
            ...
            <div className="py-8 text-center">
              <Factory size={20} className="inline text-zinc-300 mb-2" />
              <p className="text-xs text-zinc-400">
                {query ? "No plants match." : "No plants yet."}
              </p>
            </div>
          ) : (
            plants.map((p) => (
